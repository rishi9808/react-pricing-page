  ...
  const plans = [
    {
      ...
      monthlyPrice: 1000,
      yearlyPrice: 10000,
      description: "Essential for beginners to get started in Tech Industry",
      features: ["Covers foundational courses", "Interview preparation"],
    ...
    },
    {
      ...
      monthlyPrice: 1500,
      yearlyPrice: 15000,
      description: "Perfect for serious and dedicated learners",
      features: [
        "foundational + Devops courses",
